 ...
 * Clean, minimalist layout with clear typography and ample whitespace.
 *
...
<div class="woocommerce-cart-wrapper">
  <form class="woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
              ...
              <td class="product-quantity" data-title="<?php esc_attr_e('Quantity', 'woocommerce'); ?>">
                ...
                $product_quantity = woocommerce_quantity_input(
                  array(
                    ...
                    'classes'      => apply_filters('woocommerce_quantity_input_classes', array('input-text', 'qty', 'text', 'western-quantity-input'), $product_id),
                  ),
                  $_product,
                  false
                );
    ...
    <div class="cart-actions">
      ...
      <button type="submit" class="button<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?> update-cart" name="update_cart" value="<?php esc_attr_e('Update cart', 'woocommerce'); ?>"><?php esc_html_e('Update cart', 'woocommerce'); ?></button>
